javascript: (function () {
  ...
  */
  ...
  $("<button>", {
    ...
    const codeBlockElement = e.toElement.parentElement;
    ...
    console.log("codeWithCorrectEmptyLine: ", codeWithCorrectEmptyLine);
    copyTextToClipboard(codeWithCorrectEmptyLine);
    ...
    loadjs('//cdn.jsdelivr.net/gh/zawataki/popup-message/popup-message.js', {
      success: function () {
        popupMessage("Copied code to clipboard");
      }
    });
  }).prependTo('div.codeContent');
